...
?>
<div class="mb-8">
    <!--<div class="rounded-md bg-gradient-to-r from-primary to-secondary text-white border-gray-800 border-[1px] shadow-md p-4">-->
    <!--<div class="rounded-md bg-gradient-to-r from-primary to-secondary text-white shadow-md p-4">-->
    <div class="rounded-md text-black shadow-md px-4 py-2 border-gray-200 border-[1px]">
        <div id="open-form" class="flex justify-between items-stretch cursor-pointer">
            ...
            <span class="lg:text-base">
                <svg id="flipicon" class="w-[16px] h-[16px] inline transition-all" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    ...
                    <path class="fill-black" d="M2.909,4.474C1.859,6.436,17.931,37.412,20,37.412S38.401,6.482,36.987,4.474C35.573,2.467,3.958,2.513,2.909,4.474z"/>
                </svg>
            </span>
        </div>
        <form id="post_filters" class="mt-4" action="#">
            <div class="form-x flex flex-col md:flex-row md:gap-4 mb-4">
                <div class="form-item basis-4/12 mb-4">
            ...
            <button class="bg-secondary text-white text-sm text-center py-1 px-2 rounded  hover:bg-primary-400 hover:text-white inline-block"><?php esc_html_e( 'Apply Filters', 'dfrwp' ); ?></button>
            <a id="reset_filter_btn" class="bg-secondary text-white text-sm text-center py-1 px-2 rounded  hover:no-underline hover:bg-primary-400 hover:text-white inline-block cursor-pointer"><?php esc_html_e( 'Reset Filters', 'dfrwp' ); ?></a>
